...
* June 26 &mdash; Ch. 19: Deep Learning (only up to and including the section titled "Softmaxes and Cross-Entropy") [implementation](./grus/grus_ch19_code.py), [tests](./grus/grus_ch19_test.py), and examples: [XOR Neural Net](./grus/grus_ch19_xor_example.py), [Fizz Buzz Common Code](./grus/grus_ch19_fb_common.py), [Fizz Buzz Neural Net](./grus/grus_ch19_fb_example.py) and [Fizz Buzz Softmax Neural Net](./grus/grus_ch19_fb_sm_example.py)
